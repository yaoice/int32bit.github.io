...
function start()
{
     ...
     * 'block_size' KB. 
     */
    params.hda = { url: "hda/hda%d.bin", block_size: 64, nb_blocks: 912 };
    
    pc = new PCEmulator(params);

    init_state.params = params;

    pc.load_binary("boot/prefix-vmlinux-2.6.20.bin", 0x00100000, start2);
}
...
function start2(ret)
{
    ...
    pc.load_binary("boot/linuxstart.bin", init_state.start_addr, start3);
}
